# Using Lunch Flow with Moneydance

These pages are for people who want to import bank transactions into Moneydance. You do not need to be a programmer.

1. [Set up Lunch Flow](setup.md) — account, banks, API destination, which accounts the key can see  
